...
class  SAP_PART:
    def __init__(self,root,isTKroot = True):
        ...
        Label_47 = tkinter.Label(Frame_17,text="配件收货入库\r")
        Fun.Register(uiName,'Label_47',Label_47,'Label_2')
        Fun.SetControlPlace(uiName,'Label_47',35,49,146,25)#lock
        ...
        Fun.SetControlPlace(uiName,'Label_48',184,41,219,48)#lock
        ...
        Label_49 = tkinter.Label(Frame_17,text="想不出来如何设计UI界面，请直接点击按钮")
        Fun.Register(uiName,'Label_49',Label_49,'Label_4')
        Fun.SetControlPlace(uiName,'Label_49',191,171,494,48)#lock
