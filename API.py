...
class  API:
    def __init__(self,root,isTKroot = True):
        ...
        Fun.SetControlPlace(uiName,'Label_70',20,0,322,42)#lock
        Label_70.configure(bg = "#FFFFFF")
        Label_70.configure(fg = "SystemButtonText")
        Label_70.configure(anchor = "w")
        ...
        Fun.SetControlPlace(uiName,'Label_73',3,557,122,35)#lock
        ...
        Fun.SetControlPlace(uiName,'Label_77',585,135,194,30)#lock
        ...
        Label_78 = tkinter.Label(Frame_17,text="发送无响应,请检查填")
        Fun.Register(uiName,'Label_78',Label_78,'Label_5')
        Fun.SetControlPlace(uiName,'Label_78',585,169,228,30)#lock
        ...
        Fun.SetControlPlace(uiName,'Label_79',549,261,300,30)#lock
        ...
        Label_80 = tkinter.Label(Frame_17,text="写的参数是否正确")
        Fun.Register(uiName,'Label_80',Label_80,'Label_7')
        Fun.SetControlPlace(uiName,'Label_80',585,199,228,30)
        Label_80.configure(bg = "#FFFFFF")
        Label_80.configure(fg = "#656D78")
        Label_80.configure(anchor = "w")
        Label_80.configure(relief = "flat")
        Label_80_Ft=tkinter.font.Font(family='Microsoft YaHei UI', size=12,weight='normal',slant='roman',underline=0,overstrike=0)
        Label_80.configure(font = Label_80_Ft)
        ...
        Fun.SetControlPlace(uiName,'LabelButton_46',693,583,131,48)#lock
        ...
        Fun.SetControlPlace(uiName,'LabelButton_72',496,583,131,48)#lock
        ...
        Entry_55.SetText("Header")
        Entry_55.SetBGColor("#CACACA")
        Entry_55.SetFGColor("#000000")
        Entry_55_Font=tkinter.font.Font(family='Microsoft YaHei UI', size=12,weight='normal',slant='roman',underline=0,overstrike=0)
        ...
        Entry_56_Font=tkinter.font.Font(family='Microsoft YaHei UI', size=12,weight='normal',slant='roman',underline=0,overstrike=0)
        ...
        Entry_75_Font=tkinter.font.Font(family='Microsoft YaHei UI', size=12,weight='normal',slant='roman',underline=0,overstrike=0)
        ...
        Fun.SetControlPlace(uiName,'ComboBox_74',125,551,320,48)#lock
        ComboBox_74["values"]=['   ']
        ...
        Fun.SetControlPlace(uiName,'RadioButton_64',76,261,115,30)#lock
        ...
        Fun.SetControlPlace(uiName,'RadioButton_65',236,261,83,30)#lock
        ...
        Fun.SetControlPlace(uiName,'RadioButton_66',365,261,85,30)#lock
