...
class SysTray(object):
    ...
    def show_menu(self):
        ...
        SysTrayMenu.add_command(label="退出",command=lambda:Project1_cmd.Menu_退出("Project1","退出"))
...
class  Project1:
    def __init__(self,root,isTKroot = True):
        ...
        if isTKroot == True:
            ...
            if os.path.exists("Resources/图标.ico"):
                root.iconbitmap("Resources/图标.ico")
    ...
    def StartSysTrayThread(self):
        icons = r'D:\十九\Desktop\云销通小组件\源码\Project1\Resources\图标.ico'
