...
class  response:
    def __init__(self,root,isTKroot = True):
        ...
        Fun.SetControlPlace(uiName,'Label_47',22,38,81,48)
        ...
        Fun.SetControlPlace(uiName,'Label_48',103,38,117,48)#lock
        ...
        Label_48_Ft=tkinter.font.Font(family='Microsoft YaHei UI', size=15,weight='normal',slant='roman',underline=0,overstrike=0)
        ...
        Fun.SetControlPlace(uiName,'Text_46',22,121,1078,635)#lock
