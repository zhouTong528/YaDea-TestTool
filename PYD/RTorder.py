...
class  RTorder:
    def __init__(self,root,isTKroot = True):
        ...
        self.firstRun = True
        Fun.G_UICommandDictionary[uiName]=RTorder_cmd
        Fun.Register(uiName,'root',root)
        style = RTorder_sty.SetupStyle()
        if isTKroot == True:
            root.title("Form1")
        ...
        Fun.SetControlPlace(uiName,'LabelButton_12',690,562,135,48)#lock
        LabelButton_12.SetCommandFunction(RTorder_cmd.LabelButton_6_onCommand,self.uiName,"LabelButton_6")
        ...
        ListView_14.bind("<Button-1>",Fun.EventFunction_Adaptor(RTorder_cmd.ListView_1_onButton1,uiName=uiName,widgetName="ListView_1"))
        ...
        Fun.SetControlPlace(uiName,'Label_17',442,499,99,48)
        ...
        Label_18 = tkinter.Label(Frame_3,text="退货商品")
        Fun.Register(uiName,'Label_18',Label_18,'已选择商品')
        Fun.SetControlPlace(uiName,'Label_18',11,438,131,48)#lock
        ...
        Fun.SetControlPlace(uiName,'Label_19',142,438,690,48)#lock
        ...
        Label_22 = tkinter.Label(Frame_3,text="推送电商退货订单，请选择发货订单中的商品！")
        Fun.Register(uiName,'Label_22',Label_22,'Label_6')
        Fun.SetControlPlace(uiName,'Label_22',142,562,473,51)
        ...
        Label_23 = tkinter.Label(Frame_3,text="退货商品")
        Fun.Register(uiName,'Label_23',Label_23,'Label_7')
        Fun.SetControlPlace(uiName,'Label_23',11,438,131,48)#lock
        ...
        Label_24 = tkinter.Label(Frame_3,text="发货单号")
        Fun.Register(uiName,'Label_24',Label_24,'Label_8')
        Fun.SetControlPlace(uiName,'Label_24',11,382,131,48)#lock
        Label_24.configure(bg = "#FFFFFF")
        Label_24.configure(fg = "SystemButtonText")
        Label_24.configure(relief = "flat")
        Label_24_Ft=tkinter.font.Font(family='Microsoft YaHei UI', size=11,weight='normal',slant='roman',underline=0,overstrike=0)
        Label_24.configure(font = Label_24_Ft)
        Label_26 = tkinter.Label(Frame_3,text="Lab\r")
        Fun.Register(uiName,'Label_26',Label_26,'Label_9')
        Fun.SetControlPlace(uiName,'Label_26',738,11,127,102)
        Label_26.configure(bg = "SystemButtonFace")
        Label_26.configure(fg = "SystemButtonText")
        RTorder_cmd.ElementBGArray[26]=Fun.LoadImageFromFile("Resources/雅迪.png",None,uiName,'Label_9')
        RTorder_cmd.ElementBGArray_Resize[26] = RTorder_cmd.ElementBGArray[26].resize((127, 102),Image.LANCZOS)
        RTorder_cmd.ElementBGArray_IM[26] = ImageTk.PhotoImage(RTorder_cmd.ElementBGArray_Resize[26])
        Label_26.configure(image = RTorder_cmd.ElementBGArray_IM[26])
        ...
        Fun.SetControlPlace(uiName,'Entry_20',142,497,200,49)#lock
        Entry_20.bind("<FocusOut>",Fun.EventFunction_Adaptor(RTorder_cmd.输入数量_onFocusOut,uiName=uiName,widgetName="输入数量"))
        Entry_20.bind("<Key>",Fun.EventFunction_Adaptor(RTorder_cmd.输入数量_onKey,uiName=uiName,widgetName="输入数量"))
        ...
        Fun.SetControlPlace(uiName,'Entry_21',541,497,200,48)#lock
        Entry_21.SetTextChangedFunction(RTorder_cmd.输入价格_onTextChanged,uiName=uiName,widgetName="输入价格")
        Entry_25= EXUIControl.CustomEntry(Frame_3)
        Fun.Register(uiName,'Entry_25',Entry_25,'Entry_3')
        Entry_25.SetBGColor("#FFFFFF")
        Entry_25.SetFGColor("#000000")
        Entry_25_Font=tkinter.font.Font(family='Microsoft YaHei UI', size=11,weight='normal',slant='roman',underline=0,overstrike=0)
        Entry_25.SetFont(Entry_25_Font)
        Entry_25.SetTipFGColor("#888888")
        Entry_25.SetRelief("sunken")
        Fun.SetControlPlace(uiName,'Entry_25',142,381,300,49)#lock
        #Inital all element's Data 
        Fun.InitElementData(uiName)
        #Call Form_1's OnLoad Function
        RTorder_cmd.Form_1_onLoad(uiName)
