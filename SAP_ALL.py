...
class  SAP_ALL:
    def __init__(self,root,isTKroot = True):
        ...
        Fun.SetControlPlace(uiName,'Label_50',17,42,240,41)
        ...
        Fun.SetControlPlace(uiName,'Label_51',257,40,367,46)#lock
        Label_51.configure(bg = "#FFFFFF")
        Label_51.configure(fg = "#CACACA")
        Label_51.configure(anchor = "w")
        ...
        Fun.SetControlPlace(uiName,'Label_53',89,173,707,48)#lock
